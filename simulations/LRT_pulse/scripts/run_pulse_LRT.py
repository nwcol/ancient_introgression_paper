...
out_file = f"pulse_LRT_model{model_idx}_rep{rep}.csv"
stats_file = f"pulse_LRT_model{model_idx}_rep{rep}_stats.pkl"
out_graph0 = f"pulse_LRT_model{model_idx}_rep{rep}_fit0.yaml"
out_graph1 = f"pulse_LRT_model{model_idx}_rep{rep}_fit1.yaml"
...
# Evaluate at model 0 MLE parameters
p_lrt0 = np.concatenate([params0, [params1[-2], 0]])
steps0 = np.array([params1[-2], params1[-1]]) * 0.01

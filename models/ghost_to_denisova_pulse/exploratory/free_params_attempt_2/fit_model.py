...
if g.pulses[0].dest == "Denisova":
    param_file = "ghost_den_params_case0.yaml"
else:
    param_file = "ghost_den_params_case1.yaml"
...
while not converged:
    ...
    if g.pulses[0].dest == "Denisova":
        refit_param_file = "ghost_den_params_case0.yaml"
    else:
        refit_param_file = "ghost_den_params_case1.yaml"

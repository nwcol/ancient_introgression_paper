...
graph_file =  "../models/alt_yor.yaml"
param_file = "../models/alt_yor_params.yaml"
data_file = "../../../../data/statistics/main/subset_stats.pkl"
out_file = "alt_yor_example_fit.yaml"
out_tbl = "alt_yor_example_fits.csv"
...
dpluspy.plotting.plot_D_plus_curves(models=model, means=means, varcovs=varcovs,
    bins=bins, pop_ids=pop_ids, out="figure_alt_yor.pdf")
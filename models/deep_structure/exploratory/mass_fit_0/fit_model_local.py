...
graph_file =  "basal_model.yaml"
param_file = "basal_model_params.yaml"
data_file = "../../../../data/statistics/main/subset_stats.pkl"
out_file = "basal_model_fit.yaml"


u = 1.3e-8
data = dpluspy.inference.load_stats(
    data_file, graph=graph_file, return_dict=True)
pop_ids = data["pop_ids"]
bins, means, varcovs = dpluspy.bootstrapping.subset_stats(data, min_r=1e-5)
print(len(bins) - 1)

...
graph_file =  "deep_struc_subset_model.yaml"
param_file = "deep_struc_subset_model_params_TKho.yaml"
data_file = "../../../../data/statistics/main/subset_stats.pkl"
out_file = "deep_struct_subset_local_fit_TKho.yaml"
...
dpluspy.plotting.plot_D_plus_curves(models=model, means=means, varcovs=varcovs,
    bins=bins, pop_ids=pop_ids, out="fit_figure_TKho.pdf")